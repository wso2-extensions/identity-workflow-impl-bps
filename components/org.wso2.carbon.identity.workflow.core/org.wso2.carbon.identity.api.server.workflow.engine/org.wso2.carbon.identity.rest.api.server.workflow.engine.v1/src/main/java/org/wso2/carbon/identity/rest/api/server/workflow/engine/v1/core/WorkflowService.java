...
public class WorkflowService {
    ...
    private WorkflowManagementService workflowManagementService = new WorkflowManagementServiceImpl();
...
//                            workflow.getWorkflowImplId();
            ...
            List<WorkflowTemplateParameters> templateProperties = workflow.getWorkflowTemplate().getProperties();

            List<Parameter> parameterList = new ArrayList<>();

            for (WorkflowTemplateParameters properties: templateProperties){
                Parameter parameter = setWorkflowImplParameters(null, properties.getParamName(), properties.getParamValue(), properties.getqName(), "Template");
    ...
    private DetailedWorkflow getDetailedWorkflow(Workflow workflowBean, List<Parameter> workflowParameters) throws WorkflowException{
        ...
        for (Parameter parameter : workflowParameters) {
            if ("Template".equals(parameter.getHolder())) {
                ...
                WorkflowTemplateParameters additionalProperty = new WorkflowTemplateParameters();
                additionalProperty.setParamName(parameter.getParamName());
                additionalProperty.setParamValue(parameter.getParamValue());
                additionalProperty.setqName(parameter.getqName());
        ...
        workflowTemplate.setProperties(additionalProperties);

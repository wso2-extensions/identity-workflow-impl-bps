...
public class SQLConstants {
    ...
    public static final String UPDATE_WORKFLOW_QUERY = "UPDATE WF_WORKFLOW SET WF_NAME=?, DESCRIPTION=?, " +
            "TEMPLATE_ID=?, IMPL_ID=?  WHERE ID=? AND TENANT_ID=?";
    ...
    public static final String GET_ASSOCIATIONS_FOR_WORKFLOW_QUERY = "SELECT WF_WORKFLOW.WF_NAME,  " +
            ...
            "WF_WORKFLOW.ID = ? AND WF_WORKFLOW.TENANT_ID = ?";
    ...
    public static final String DELETE_ASSOCIATION_QUERY = "DELETE FROM WF_WORKFLOW_ASSOCIATION WHERE ID = ? AND " +
            "WORKFLOW_ID IN (SELECT ID FROM WF_WORKFLOW WHERE TENANT_ID = ?)";
    ...
    public static final String GET_WORKFLOW = "SELECT WF_WORKFLOW.WF_NAME, WF_WORKFLOW.DESCRIPTION, WF_WORKFLOW" +
            ".TEMPLATE_ID, WF_WORKFLOW.IMPL_ID, WF_WORKFLOW.TENANT_ID FROM WF_WORKFLOW WHERE WF_WORKFLOW.ID = ? AND " +
            "WF_WORKFLOW.TENANT_ID = ?";

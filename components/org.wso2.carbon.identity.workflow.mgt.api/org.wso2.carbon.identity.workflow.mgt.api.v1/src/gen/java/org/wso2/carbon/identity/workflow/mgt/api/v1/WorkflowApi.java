...
public class WorkflowApi  {
    ...
    public Response workflowWorkflowIdPatch(@ApiParam(value = "ID of the workflow request.",required=true) @PathParam("workflow-id") String workflowId) {

        return delegate.workflowWorkflowIdPatch(workflowId );
    }
